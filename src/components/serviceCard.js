...
const serviceCard = props => {
  const { title, description, icon, margin = "" } = props
  return (
    <div
      className={`service-card card-color mx-2 mb-8 px-8 ${margin} pt-24 pb-6 w-5/6 flex-grow-0 flex-shrink-0 flex-basis-auto rounded-md shadow-md md:w-1/2 md:shadow-lg lg:w-1/3`}
    >
